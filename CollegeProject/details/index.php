    ...
    <body>
        <div class="hero">
            <header class="header">
                <div class="container">
                    <div class="box-logo">
                        <a class="clm" href="index.php"
                            ><span>+</span>medical</a
                        >
                        <span ><a class="sp1" href="../login-user/userLogin.php" >Login</a></span>
                       <span ><a class="sp1" href="../forms/index.php" >Signup</a></span>
                    ...
                    <div class="nav-box">
                        <ul class="nav">
                            <ul class="ul-lest">
                                ...
                                <li>
                                    <a href="../Treatments/Treatment.php">
                            ...
                            <ul class="ul-lest">
                                <li>
                                    <a href="../staff/task222.php">
                                        <i class="fa-solid fa-server"></i>
                                        <span>staff</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="../clinics/taskk.php">
                                        <span>clinic</span>
                                    </a>
                                </li>
                                <li>
